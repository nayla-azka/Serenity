   ...
   public function viewArchive()
    ...
    public function deleteArchivedSession($sessionId)
    {
        try {
            ...
            Log::info("Student permanently deleting archived session {$sessionId}");
            ...
            Log::info("Archived session {$sessionId} deleted by student");
            ...
            Log::error('Error deleting archived session: ' . $e->getMessage(), [
                'trace' => $e->getTraceAsString()
            ]);
            return response()->json([
                'error' => 'Failed to delete session. Please try again.',
