...
class SiswaDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            // NEW: Add repeat_grade status column
            ->addColumn('repeat_grade', function($q) {
                if ($q->repeat_grade) {
                    return '<span class="badge bg-warning text-dark" style="font-size: 11px; padding: 4px 8px;">
                        <i class="fas fa-redo"></i> Mengulang
                    </span>';
                }
            ...
            ->rawColumns(['photo', 'repeat_grade', 'action'])
            ->setRowId('id_student');
        }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('nis')->title('NIS')->width(90),
            ...
            Column::make('repeat_grade')->title('Status')->width(100)->addClass('text-center'), // NEW
