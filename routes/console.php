...
use App\Console\Commands\CleanupInactiveChatSessions;

// Register console commands
Artisan::command('chat:cleanup {--dry-run : Run in dry-run mode without making changes} {--force : Skip confirmation prompts} {--days=30 : Number of days for auto-cleanup threshold}', function () {
    // This will be handled by the CleanupInactiveChatSessions command class
    $this->call(CleanupInactiveChatSessions::class, [
        '--dry-run' => $this->option('dry-run'),
        '--force' => $this->option('force'),
        '--days' => $this->option('days')
    ]);
})->purpose('Clean up inactive chat sessions that have been ended for more than specified days');
