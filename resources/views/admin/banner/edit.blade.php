            ...
            <div class="card-body">
                <form action="{{route('admin.banner.update', $banner->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <div id="image-preview" class="image-preview">
                            <img src="{{ asset('storage/'.$banner->photo) }}" alt="gambar banner" width="150" class="mb-2 photo-img">
                            <input type="file" name="photo" class="form-control input-style" value="{{ $banner->photo }}">
                          </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="title" class="form-control input-style" value="{{$banner->title}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <textarea name="desc" class="form-control h-auto input-style" rows="3">{{$banner->desc }}</textarea>
                        </div>
                    </div>
