...
<meta name="pusher-cluster" content="{{ env('PUSHER_APP_CLUSTER') }}">
 ...
 <style>
    ...
    /* Laporan detail modal - lower priority */
    #laporanModal {
        z-index: 1050 !important;
    }

    #laporanModal .modal-backdrop {
        z-index: 1040 !important;
    }

    /* Confirm modal - highest priority (appears on top of other modals) */
    #confirmModal {
    ...
    /* When confirm modal is shown over laporan modal */
    .modal-backdrop.show:nth-of-type(2) {
        z-index: 1055 !important;
    }

    /* Ensure alert container stays above everything */
    .alert-fixed {
    ...
    /* Make sure confirm modal backdrop is darker when shown over another modal */
...
function showConfirm(message, callback, title = "Konfirmasi") {
    ...
    // Show confirm modal with proper backdrop handling
    $("#confirmModal").modal({
        backdrop: 'static',
        keyboard: false
    }).modal("show");
